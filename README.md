...
Collection of vim, tmux, and zsh configurations. Forked from [nicknisi's awesome dotfiles for OSX](https://github.com/nicknisi/dotfiles), this project will be expanded to include support for linux.
